...
output "aws_load_balancer_controller_role_arn" {
  description = "ARN of the Prod AWS Load Balancer Controller IAM role."
...
output "frontend_workload_role_arn" {
  description = "ARN of the Prod frontend workload IAM role."
  value = var.workload_identity_mode == "pod_identity" ? (
...
output "backend_workload_role_arn" {
  description = "ARN of the Prod backend workload IAM role."
  value = var.workload_identity_mode == "pod_identity" ? (
